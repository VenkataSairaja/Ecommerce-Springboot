...
<form id="supplierForm" action="https://formcarry.com/s/Pq3xf4Lbabh" method="POST" onsubmit="showConfirmation(event)">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="confirmationModalLabel">Complaint Registered</h5>
